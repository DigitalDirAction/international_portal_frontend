...
import { Box, Typography, Paper, Avatar, Grid, IconButton, Dialog, DialogTitle, DialogContent, useMediaQuery, useTheme } from '@mui/material';
    ...
    const fetchApplicationData = async () => {
      try {
        const response = await fetch(
          `${import.meta.env.VITE_BASE_URL}get_application/${applicationId}`,
          {
            method: 'GET',
            headers: {
        ...
        fetchProgramName(data.data.application.program_id);
      } catch (err) {
        ...
        <Paper sx={{ 
          ...
          <Box sx={{ 
            ...
            <Box display="flex" alignItems="center" gap={1}>
              <ArrowBackIcon  sx={{ color: "#790077" }} onClick={()=>navigate('/applications')}/>
            ...
            <Grid container spacing={isMobile || isTablet ? 6 : 2}>
              ...
              <Grid item xs={12} md={3}>
                    <Box sx={{ 
                      ...
                      <Typography variant="body2" sx={{fontSize:'14px', color: '#686868', fontWeight: 400, mb: 1}}>Comments</Typography>
